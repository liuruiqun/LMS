...
// device's needs
#define p2p_test_ENDPOINT           10
#define BYTE                        byte
#define p2p_test_PROFID             0x0F04
#define p2p_test_DEVICEID           0x0001
#define p2p_test_DEVICE_VERSION     0
#define p2p_test_FLAGS              0

#define p2p_test_MAX_CLUSTERS       2
#define p2p_test_CLUSTERID          1
//#define fire_extinguisher_clusterId  2 
  
// Send Message Timeout
#define p2p_test_SEND_MSG_TIMEOUT   6000     //unit miniseconds
// Application Events (OSAL) - These are bit weighted definitions.
#define p2p_test_SEND_MSG_EVT       0x0001
...
//uint16 halAdcSampleSingle(void);
 ...
 */
extern void p2p_test_Init( byte task_id );

/*
 * Task Event Processor for the Generic Application
 */
extern UINT16 p2p_test_ProcessEvent( byte task_id, UINT16 events );

extern void p2p_test_SendRainfall(void);
