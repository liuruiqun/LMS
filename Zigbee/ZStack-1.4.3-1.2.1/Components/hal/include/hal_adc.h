...
extern uint16 HalDiffAdcRead(uint8 channel0, uint8 channel1, uint8 resolution);

extern uint16 HalReadExtVcc(uint8 resolution);

/*
 * 
 */
extern uint16 HalAdcReadVcc ( uint8 resolution);
