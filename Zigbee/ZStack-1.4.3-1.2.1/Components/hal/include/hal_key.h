...
#define FUN_SELECT_GENERAL      0
#define FUN_SELECT_PERIPHERAL   1

#define DIRECTION_INPUT         0
#define DIRECTION_OUTPUT        1

#define INPUT_MODE_PULLUP       0
#define INPUT_MODE_PULLDOWN     1
#define INPUT_MODE_TRISTATE     2
#define INPUT_MODE_NULL         3

#define RISE_EDGE               0
#define FALL_EDGE               1
/*
 * Open P1 Interrupt Service
 */
extern void OpenP1Interrupt( uint8 pin, uint8 FunSelect, uint8 direction, uint8 InputMode, uint8 RiseFallEdge);

extern void CloseP1Interrupt(uint8 pin);

extern void StartP1Interrupt(uint8 pin);

extern void StopP1Interrupt(uint8 pin);

extern void RegisterP1Interrupt(uint8 pin, uint8 TaskID);

extern uint8 QueryP1Interrupt(uint8 pin);

extern void HalP1InterruptConfig( void );

extern void P1_0_ISR_fun( void );
extern void P1_1_ISR_fun( void );
extern void P1_2_ISR_fun( void );
extern void P1_3_ISR_fun( void );
extern void P1_4_ISR_fun( void );
extern void P1_5_ISR_fun( void );
extern void P1_6_ISR_fun( void );
extern void P1_7_ISR_fun( void );
