 ...
 * LOCAL FUNCTIONS
 */
static ZStatus_t zclSS_HdlIncoming( zclInHdlrMsg_t *pInHdlrMsg );
static ZStatus_t zclSS_HdlInSpecificCommands( zclIncoming_t *pInMsg, uint16 logicalClusterID );

#if defined(ZCL_ZONE) || defined(ZCL_ACE) || defined(ZCL_WD)
static zclSS_AppCallbacks_t *zclSS_FindCallbacks( uint8 endpoint );
#endif // ZCL_ZONE || ZCL_ACE || ZCL_WD
...
ZStatus_t zclSS_RegisterCmdCallbacks( uint8 endpoint, zclSS_AppCallbacks_t *callbacks )
{
  ...
  {
    zcl_registerPlugin( ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ZONE,
                        ZCL_SS_LOGICAL_CLUSTER_ID_IAS_WD,
                        zclSS_HdlIncoming );
                                       ...
                                       uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ZONE, TRUE,
                                ...
                                uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ZONE,
                           TRUE, COMMAND_SS_IAS_ZONE_STATUS_ENROLL_REQUEST, TRUE, 
                                         ...
                                         uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ZONE,
                           TRUE, COMMAND_SS_IAS_ZONE_STATUS_ENROLL_RESPONSE, TRUE, 
                          ...
                          uint8 armMode, uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE,
                          TRUE, COMMAND_SS_IAS_ACE_ARM, TRUE, 
                                        ...
                                        uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  if ( buf )
  {
    ...
    *pBuf++ = numberOfZones;
    ...
    stat = zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE,
                            TRUE, COMMAND_SS_IAS_ACE_BYPASS, TRUE, 
                                  ...
                                  uint8 zoneID, uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE,
                          TRUE, COMMAND_SS_IAS_ACE_GET_ZONE_INFORMATION, TRUE, 
                          ZCL_FRAME_CLIENT_SERVER_DIR, disableDefaultRsp, 0, seqNum, 1, buf );
}
                  ...
                  uint8 armNotification, uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE,
                          TRUE, COMMAND_SS_IAS_ACE_ARM_RESPONSE, TRUE, 
                                ...
                                uint16 *zoneIDMap, uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  if ( buf )
  {
    ...
    stat = zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE,
                            TRUE, COMMAND_SS_IAS_ACE_GET_ZONE_ID_MAP_RESPONSE, TRUE, 
                                             ...
                                             uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  if ( buf )
  {
    ...
    stat = zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE, TRUE,
                                       ...
                                       uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_WD,
                          TRUE, COMMAND_SS_IAS_WD_START_WARNING, TRUE, 
                                       ...
                                       uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_SS_LOGICAL_CLUSTER_ID_IAS_WD,
                           TRUE, COMMAND_SS_IAS_WD_SQUAWK, TRUE, 
                          ZCL_FRAME_CLIENT_SERVER_DIR, disableDefaultRsp, 0, seqNum, 1, buf);
}
#endif // ZCL_WD
...
static ZStatus_t zclSS_HdlIncoming( zclInHdlrMsg_t *pInHdlrMsg )
{
  ...
  if ( zcl_ClusterCmd( pInHdlrMsg->msg->hdr.fc.type ) )
  {
    ...
    {
      stat = zclSS_HdlInSpecificCommands( pInHdlrMsg->msg, pInHdlrMsg->logicalClusterID );
    }
    else
    {
...
static ZStatus_t zclSS_HdlInSpecificCommands( zclIncoming_t *pInMsg, uint16 logicalClusterID )
{
  ...
  {
#ifdef ZCL_ZONE
    case ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ZONE:
      if ( zcl_ServerCmd( pInMsg->hdr.fc.direction ) )
        stat = zclSS_ProcessInZoneStatusCmdsServer( pInMsg );
      else
        stat = zclSS_ProcessInZoneStatusCmdsClient( pInMsg );
      break;
#endif // ZCL_ZONE

#ifdef ZCL_ACE
    case ZCL_SS_LOGICAL_CLUSTER_ID_IAS_ACE:
      if ( zcl_ServerCmd( pInMsg->hdr.fc.direction ) )
        stat = zclSS_ProcessInACECmdsServer( pInMsg );
      else
        stat = zclSS_ProcessInACECmdsClient( pInMsg );
      break;
#endif // ZCL_ACE

#ifdef ZCL_WD      
    case ZCL_SS_LOGICAL_CLUSTER_ID_IAS_WD:
      stat = zclSS_ProcessInWDCmds( pInMsg );
      break;
#endif // ZCL_WD
...
static ZStatus_t zclSS_ProcessInZoneStatusCmdsServer( zclIncoming_t *pInMsg )
{
  ...
  if ( pInMsg->hdr.commandID == COMMAND_SS_IAS_ZONE_STATUS_ENROLL_RESPONSE )
    zclSS_ProcessInCmd_ZoneStatus_EnrollResponse( pInMsg );
  else
    stat = ZFailure;
...
static ZStatus_t zclSS_ProcessInZoneStatusCmdsClient( zclIncoming_t *pInMsg )
{
  ...
  switch ( pInMsg->hdr.commandID )				
  {
    case COMMAND_SS_IAS_ZONE_STATUS_CHANGE_NOTIFICATION:
      zclSS_ProcessInCmd_ZoneStatus_ChangeNotification( pInMsg );
      break;

    case COMMAND_SS_IAS_ZONE_STATUS_ENROLL_REQUEST:
      stat = zclSS_ProcessInCmd_ZoneStatus_EnrollRequest( pInMsg );
      break;
...
static ZStatus_t zclSS_ProcessInACECmdsServer( zclIncoming_t *pInMsg )
{
  ...
  switch ( pInMsg->hdr.commandID )				
  {
    case COMMAND_SS_IAS_ACE_ARM:
      stat = zclSS_ProcessInCmd_ACE_Arm( pInMsg );
      break;

    case COMMAND_SS_IAS_ACE_BYPASS:
      zclSS_ProcessInCmd_ACE_Bypass( pInMsg );
      break;

    case COMMAND_SS_IAS_ACE_EMERGENCY:
      zclSS_ProcessInCmd_ACE_Emergency( pInMsg );
      break;

    case COMMAND_SS_IAS_ACE_FIRE:
      zclSS_ProcessInCmd_ACE_Fire( pInMsg );
      break;

    case COMMAND_SS_IAS_ACE_PANIC:
      zclSS_ProcessInCmd_ACE_Panic( pInMsg );
      break;
...
static ZStatus_t zclSS_ProcessInACECmdsClient( zclIncoming_t *pInMsg )
{
  ...
  switch ( pInMsg->hdr.commandID )				
  {
    case COMMAND_SS_IAS_ACE_ARM_RESPONSE:
      zclSS_ProcessInCmd_ACE_ArmResponse( pInMsg );
      break;

    case COMMAND_SS_IAS_ACE_GET_ZONE_ID_MAP_RESPONSE:
      zclSS_ProcessInCmd_ACE_GetZoneIDMapResponse( pInMsg );
      break;

    case COMMAND_SS_IAS_ACE_GET_ZONE_INFORMATION_RESPONSE:
      zclSS_ProcessInCmd_ACE_GetZoneInformationResponse( pInMsg );
      break;
...
static void zclSS_ProcessInCmd_ZoneStatus_ChangeNotification( zclIncoming_t *pInMsg )
{
  ...
  pCBs = zclSS_FindCallbacks( pInMsg->msg->endPoint );
  if ( pCBs && pCBs->pfnChangeNotification )
  {
...
static void zclSS_ProcessInCmd_ZoneStatus_EnrollResponse(zclIncoming_t *pInMsg )
{
  ...
  pCBs = zclSS_FindCallbacks( pInMsg->msg->endPoint );
  if ( pCBs && pCBs->pfnEnrollResponse )
  {
...
static void zclSS_ProcessInCmd_ACE_ArmResponse( zclIncoming_t *pInMsg )
{
  ...
  pCBs = zclSS_FindCallbacks( pInMsg->msg->endPoint );
  if ( pCBs && pCBs->pfnACE_ArmResponse )
...
static void zclSS_ProcessInCmd_ACE_GetZoneIDMapResponse( zclIncoming_t *pInMsg )
{
  ...
  if ( buf )
  {
    ...
    pCBs = zclSS_FindCallbacks( pInMsg->msg->endPoint );
    if ( pCBs && pCBs->pfnACE_GetZoneIDMapResponse )
...
static void zclSS_ProcessInCmd_ACE_GetZoneInformationResponse( zclIncoming_t *pInMsg )
{
  ...
  pCBs = zclSS_FindCallbacks( pInMsg->msg->endPoint );
  if ( pCBs && pCBs->pfnACE_GetZoneInformationResponse )
  {
...
static ZStatus_t zclSS_ProcessInWDCmds( zclIncoming_t *pInMsg )
{
  ...
  switch ( pInMsg->hdr.commandID )				
  {
    case COMMAND_SS_IAS_WD_START_WARNING:
      zclSS_ProcessInCmd_WD_StartWarning( pInMsg );
      break;

    case COMMAND_SS_IAS_WD_SQUAWK:
      zclSS_ProcessInCmd_WD_Squawk( pInMsg );
      break;
...
static void zclSS_ProcessInCmd_WD_StartWarning( zclIncoming_t *pInMsg )
{
  ...
  pCBs = zclSS_FindCallbacks( pInMsg->msg->endPoint );
  if ( pCBs && pCBs->pfnWD_StartWarning )
  {
